...
public class RestApi {
	...
	String deploymentId = "com.caomcast.csp:comcast:1.0";
    URL deploymentUrl;
...
public void startProcess(){
   ...
   params.put("serviceinput","jey");
    
    ProcessInstance processInstance = ksession.startProcess("cspproject.cspProcess", params);
...
public void completeItem(){
    ...
    params.put("result", "completed");
   // ksession.getWorkItemManager().completeWorkItem(2, params);
    ksession.signalEvent("waitSignal", "please complete");
}
